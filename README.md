...
Accuracy is currently not high, but can be improved with better image preprocessing or text detection. Currently only California Driver's Licenses are supported.
